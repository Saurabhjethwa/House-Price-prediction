...
data = pd.read_csv("C:\\Users\\LENOVO\\Desktop\\project\\attachments\\train.csv") 
data.head()
...
top1 = numerical.corr()
features_list_new = top1[abs(top1) > 0.5]
print(features_list_new)
features_list_new.to_csv('C:\\Users\\LENOVO\\Desktop\\project\\attachments\\corr.csv')

###################################################

numerical['OverallArea'] = numerical['GrLivArea'] + numerical['GarageArea'] + numerical['MasVnrArea']

numerical['PricePerSF'] = numerical['SalePrice'] / numerical['OverallArea']

numerical.to_csv('C:\\Users\\LENOVO\\Desktop\\project\\attachments\\numerical.csv')

numerical['OverallArea'].corr(numerical['SalePrice'])

numerical['PricePerSF'].corr(numerical['SalePrice'])
...
corr.to_csv('C:\\Users\\LENOVO\\Desktop\\project\\attachments\\numerical1.csv')
