# -*- coding: utf-8 -*-
"""
Created on Tue Nov  6 16:17:16 2018
...
# Load the data.
train_df = pd.read_csv("C:\\Users\\Polestar User\\Desktop\\housing\\train.csv")
test_df = pd.read_csv("C:\\Users\\Polestar User\\Desktop\\housing\\test.csv")
...
predtest = ENSTest.predict(test_df_munged)
...
GBest = ensemble.GradientBoostingRegressor(n_estimators=5000, learning_rate=0.03, max_depth=4, max_features='sqrt',
                                               min_samples_leaf=12, min_samples_split=10, loss='huber').fit(X, y)

predtest = GBest.predict(test_df_munged)
predtest=np.exp(predtest)
...
X = pd.read_csv("C:\\Users\\Polestar User\\Desktop\\data2train.csv")

y = pd.read_csv('C:\\Users\\Polestar User\\Desktop\\data2saleprice.csv')
...
Final_labels = (np.exp(GB_model.predict(test_df_munged)) + np.exp(ENST_model.predict(test_df_munged))) / 2
...
train_df_munged.to_csv('C:\\Users\\Polestar User\\Desktop\\data2train.csv')
test_df_munged.to_csv('C:\\Users\\Polestar User\\Desktop\\data2test.csv')

y.to_csv('C:\\Users\\Polestar User\\Desktop\\data2saleprice.csv')
...
Final_labels = ( np.exp(ENST_model.predict(test)) + np.exp(regr.predict(test))) / 2
...
sub1['Id'] = test_df['Id']
sub1['SalePrice'] = Final_labels
sub1.to_csv('C:\\Users\\Polestar User\\Desktop\\finalsubmit\\data2NewStack.csv',index=False)

#########################################################################

train = pd.read_csv("C:\\Users\\Polestar User\\Documents\\regression\\HousePriceFinal\\data2train.csv")
test = pd.read_csv("C:\\Users\\Polestar User\\Documents\\regression\\HousePriceFinal\\data2test.csv")
